        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button onClick={() => setModal("bulkUpload")}
              className="flex items-center gap-1.5 px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:border-gray-400 bg-white transition-all">
              <Download className="w-4 h-4" /> Bulk Upload
            </button>
            <button onClick={() => setModal("newPayroll")}
              className="flex items-center gap-1.5 px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:border-blue-400 hover:text-blue-600 bg-white transition-all">
              <Plus className="w-4 h-4" /> New Payroll
            </button>
            <button onClick={() => setModal("processConfirm")} disabled={payrollLocked}
              className="flex items-center gap-1.5 px-4 py-2 bg-blue-600 rounded-lg text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all">
